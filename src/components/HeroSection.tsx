      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Publishing transformative books and conducting insightful workshops 
              under the visionary leadership of <strong className="text-foreground">Dr. Priyanka Verma</strong>
            </motion.p>
